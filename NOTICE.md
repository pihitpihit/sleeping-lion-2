...
이 저장소의 **소스 코드**는 MIT 라이선스다([LICENSE](./LICENSE)). 아래 자료는 각자의
라이선스를 따르며 MIT로 재배포되지 않는다.
...
Creator Pack 원 스레드는 게임에 쓰인 서체 셋을 알려준다. 그러나 **저작자가
라이선스한 것은 에셋이지 서체가 아니다** — 서체는 그의 소유가 아니다.
